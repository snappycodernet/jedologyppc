      ...
      <div className="row">
        <div className="col-md-6 col-sm-12">
          <div className="bodyText">
            <p className="lead">
              As a <strong>Certified Google Ads Specialist</strong>, I can help you exceed your marketing goals for less and half the time. Leave the stress about
              online marketing behind and hire an expert who will simplify the process for you. <br />
              <br />
